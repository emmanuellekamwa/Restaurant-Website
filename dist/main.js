(() => {
    ...
    var n = {
            950: (n, e, r) => {
                n.exports = r.p + "9730bcfa12d11f3cb01f.jpg";
            },
            426: (n, e, r) => {
                r.d(e, { Z: () => d });
                var t = r(645),
            ...
            667: (n) => {
                n.exports = function (n, e) {
                    return (
                        e || (e = {}),
                        "string" !=
                        typeof (n = n && n.__esModule ? n.default : n)
                            ? n
                ...
                n.exports = function (n, e) {
                    ...
                    return function (n) {
                        if (
                            ...
                            for (var s = c(n, e), l = 0; l < r.length; l++) {
                                var d = o(r[l]);
                                0 === i[d].references &&
                                    (i[d].updater(), i.splice(d, 1));
                            }
                            r = s;
                        }
                    };
        ...
        (() => {
            ...
            const a = document.querySelector("body"),
                ...
                c = (n, e = "") => {
                    ...
                    return (r.textContent = n), r.classList.add(e), r;
                };
            o.appendChild(c("Home", "tab-button")),
                o.appendChild(c("Menu", "tab-button")),
                o.appendChild(c("Contacts", "tab-button")),
                a.appendChild(o);
            const s = document.getElementsByClassName("tab-button"),
                l = (n) => {
                    const e = document.getElementsByClassName("tab-button");
                        ...
                        case "Home":
                            i.appendChild(
                                ((n, e = "") => {
                                    ...
                                    "All your delicious exotic meals at an affordable price"
                                )
                            );
                            break;
                        case "Menu":
